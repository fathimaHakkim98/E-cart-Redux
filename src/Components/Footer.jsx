...
function Footer() {
    return (
        <>
            <div style={{ height: '300px' }} className=' mt-5 w-100 bg-dark text-white'>
                <div className=" container pt-5 footer-content d-flex justify-content-between ">
                    <div style={{ width: '400px' }} className="media">
                        <h5 className='d-flex'><i style={{ height: '25px' }} className="fa-solid fa-truck-fast me-3"></i>
                            E-Cart</h5>
                        <p style={{ textAlign: 'justify' }}>Designed and built with all the love in the world by the React team with the help of our contributors.</p>
                        <span>Code licensed FATH, docs CC BY 3.0.</span><br />
                        <span>Currently v2.3.2.</span>
                    </div>
